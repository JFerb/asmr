"""LaserScan / PointCloud2 helpers for the perception pipeline.

Pure functions (no Node): angular-sector minimum range, threshold checks,
and PointCloud2 -> (N, 2) xy unpacking. No rclpy dependency so they unit-test
directly.
"""
import math
